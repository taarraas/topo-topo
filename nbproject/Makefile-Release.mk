...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/topo-topo: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/topo-topo ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/TopoView.o: TopoView.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TopoView.o TopoView.cpp
...
${OBJECTDIR}/Cylinder.o: Cylinder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Cylinder.o Cylinder.cpp

${OBJECTDIR}/OpenGlRenderer.o: OpenGlRenderer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OpenGlRenderer.o OpenGlRenderer.cpp
...
${OBJECTDIR}/SceneFactory.o: SceneFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SceneFactory.o SceneFactory.cpp
